...
import com.limjae.weather.openapi.time.impl.LiveShortTime;
...
public class LiveForecastApiUri implements OpenApiUri {
    ...
    private final LiveShortTime liveTime;
    ...
    public URI getURI() {
        try {
            OpenApiParameter openApiParameter = new OpenApiParameter(liveTime, LocalDateTime.now(), LocationEnum.SEOUL);
